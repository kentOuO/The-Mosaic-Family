...
public class PlayerInteract : MonoBehaviour
{
    ...
    private void Update()
    {
        // Check if the E key is pressed and if the UI is active for Puzzle
        ...
        // Check if the E key is pressed and if the UI is active for Furniture
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            Debug.Log("Entered Puzzle Collider");
    ...
    private void OnTriggerExit2D(Collider2D other)
    {
        ...
        if (other.CompareTag("Puzzle"))
        {
            Debug.Log("Exited Puzzle Collider");
            ...
            currentInteractButton = null; // Reset the current interact button
        }
